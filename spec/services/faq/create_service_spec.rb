...
describe FaqLinkModule::CreateService do
  ...
  describe '#call' do
    it "Without hashtag params, will receive a error" do
      @createService = FaqLinkModule::CreateService.new({"question.original" => @question, "answer.original" => @answer})
    ...
    it "With valid params, receive success message" do
      @createService = FaqLinkModule::CreateService.new({"question.original" => @question, "answer.original" => @answer, "hashtags.original" => @hashtags})
